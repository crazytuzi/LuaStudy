...
把数字：整型或者浮点型 转成 TString 类型
先用 snprintf 格式化成 char 字符串，然后创建 TString，最后设置到原来的整型变量中 
*/
...
/* 把一个字符串入栈到 L->top 处，然后 L->top 递增1 */
